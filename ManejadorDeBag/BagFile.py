...
import numpy as np
from cv2 import imwrite,cvtColor, COLOR_BGR2RGBA
...
class BagFile:
    ...
    def save_color_image(self, color_frame, frame_number):
        ...
        color_image = cvtColor(color_image, COLOR_BGR2RGBA)
        imwrite(f'{self.images_folder}/frame_{frame_number:05d}.png', color_image)
